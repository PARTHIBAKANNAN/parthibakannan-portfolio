                ...
                <div className="glass hover-card" style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
                  {h.image && (
                    <div style={{ position: "relative", height: 150, flexShrink: 0 }}>
                      ...
                      <div style={{ position: "absolute", left: 18, bottom: -20, width: 46, height: 46, borderRadius: 13, background: `linear-gradient(135deg, ${accent}, ${accentDeep})`, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: `inset 0 1px 0 rgba(255,255,255,0.3), 0 14px 28px -10px ${accent}88` }}>
