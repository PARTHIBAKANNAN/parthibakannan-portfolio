...
import { Mail, Phone, ArrowUpRight, Download, Linkedin, Github, Copy, Check, Sparkles, Send, MessageSquare } from "lucide-react";
...
export function Contact() {
  ...
  return (
    <section id="contact" className="section mesh-bg" style={{ borderTop: "1px solid var(--line)", paddingBottom: 110 }}>
      <div className="container">
        <Reveal style={{ maxWidth: 880, margin: "0 auto" }}>
          
          {/* Header */}
          <div style={{ textAlign: "center", marginBottom: 38 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "5px 12px", borderRadius: 999, background: "rgba(124,92,255,0.12)", border: "1px solid rgba(124,92,255,0.3)", marginBottom: 14 }}>
              <span style={{ width: 7, height: 7, borderRadius: 999, background: t.success, boxShadow: `0 0 8px ${t.success}` }} />
              <span className="font-mono" style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: t.irisBright }}>Direct Communication Terminal</span>
            </div>
            <h2 className="font-display" style={{ fontSize: "clamp(32px, 4.6vw, 48px)", fontWeight: 800, color: t.ink, margin: "0 0 14px", lineHeight: 1.1 }}>
              Let's build something exceptional.
            </h2>
            <p style={{ fontSize: 16.5, lineHeight: 1.6, color: t.inkSoft, maxWidth: 620, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16, marginBottom: 32 }}>
            ...
            <div className="glass-strong hover-card" style={{ padding: "24px 22px", borderRadius: 18 }}>
              ...
              <div className="font-mono" style={{ fontSize: 11, color: t.inkMuted, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 4 }}>Phone &amp; WhatsApp</div>
