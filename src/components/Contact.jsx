    ...
    <section id="contact" className="section mesh-bg" style={{ borderTop: "1px solid var(--line)" }}>
      <div className="container">
        <Reveal style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 className="font-display heading-huge" style={{ fontSize: "clamp(32px, 4.6vw, 50px)", margin: "0 0 16px" }}>Hiring for a Gen AI role?</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 14, marginBottom: 34 }}>
            ...
            <a href="tel:+919123591335" className="glass hover-card" style={{ padding: 22, textAlign: "left", display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: `linear-gradient(135deg, ${t.auroraBright}, ${t.irisDeep})`, display: "flex", alignItems: "center", justifyContent: "center" }}><Phone size={18} color="#fff" /></div>
              <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <a href={RESUME_PDF} download="Parthibakannan_S_Resume.pdf" className="btn-primary"><Download size={15} /> Download résumé</a>
