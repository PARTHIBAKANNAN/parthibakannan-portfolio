...
export const flagshipQuantWork = [
  {
    id: "pulsehunter",
    title: "PulseHunter · Real-Time Market Research Terminal",
    eyebrow: "Real-Time Quant · 212+ Stocks · Google Gemini Copilot",
    tagline: "A real-time market-research terminal monitoring 212+ Indian equities with HTML5 canvas charts, a 5-tier filter matrix, a Gemini-based signal-audit copilot, and 250ms WebSocket state streaming.",
  ...
  {
    id: "nukebox",
    title: "NUKEBOX · Paper-Trading Derivatives Research Terminal",
    eyebrow: "Paper Trading · 44 Strategy Variants",
    tagline: "A paper-trading derivatives research terminal with 44 intraday strategy variants, a Black-Scholes Greeks engine, pre-market catalyst synthesis, and Telegram risk notifications. Broker order execution is a planned enhancement, not a current feature.",
    status: "Paper-trading terminal",
    ...
    approach: "Built a full-stack paper-trading platform modelling 44 intraday strategy variants across NIFTY, SENSEX, and BANKNIFTY. A scheduled catalyst workflow synthesizes market context; Black-Scholes Greeks support simulated Stop-Loss, Take-Profit, and Time-Exit rules, with Telegram notifications and Supabase audit logging.",
    outcome: "A paper-trading environment for exploring 44 strategy variants across three Indian indices with simulated risk controls and signal dispatch. It does not place broker orders.",
    metrics: [
      { label: "Strategy Variants", value: "44 Paper-Trading Models" },
...
export const hackathonWork = [
  ...
  {
    title: "TheraBot",
    subtitle: "AI Wellness Prototype",
    icon: Heart,
    accent: "aurora",
    ...
    desc: "An AI wellness prototype engineered with Google Gemini, FastAPI, React TypeScript, and MongoDB Atlas. It explores guided thought records, paced-breathing interactions, bi-directional voice, soundscapes, and a somatic tension heatmap. It is not a clinical service or emergency-response tool.",
    agenticHighlights: [
